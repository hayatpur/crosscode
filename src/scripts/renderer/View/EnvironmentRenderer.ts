...
import { FunctionRenderer } from '../../environment/data/reference/FunctionRenderer'
...
export interface EnvironmentRendererRepresentation {
    reads: string[]
    writes: string[]
}
...
export class EnvironmentRenderer {
    ...
    setState(state: EnvironmentState, representation: EnvironmentRendererRepresentation = null) {
    ...
    renderMemory(state: EnvironmentState, representation: EnvironmentRendererRepresentation) {
        // Cached
        if (
    ...
    renderIdentifiers(state: EnvironmentState, representation: EnvironmentRendererRepresentation) {
        // Hit test
        const hits = new Set()

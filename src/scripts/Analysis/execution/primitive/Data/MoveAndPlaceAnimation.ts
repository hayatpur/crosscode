import { DataState, instanceOfData } from '../../../../DataView/Environment/data/DataState'
import { replaceDataWith } from '../../../transpiler/data'
...
function computeReadAndWrites(animation: MoveAndPlaceAnimation, inputData: DataInfo, outputData: DataInfo | null) {
    animation._reads = [inputData]
    animation._writes = outputData ? [outputData, inputData] : [inputData]
}

export function moveAndPlaceAnimation(inputSpecifier: Accessor[], outputSpecifier: Accessor[]): MoveAndPlaceAnimation {
    return {
        ...createExecutionNode(),

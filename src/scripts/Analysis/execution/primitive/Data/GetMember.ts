import { DataState, DataType, instanceOfData } from '../../../../DataView/Environment/data/DataState'
...
function apply(animation: GetMember, environment: EnvironmentState) {
    ...
    replaceDataWith(outputRegister, createPrimitiveData(DataType.ID, copy.id, `${animation.id}_OutputRegister`))
}

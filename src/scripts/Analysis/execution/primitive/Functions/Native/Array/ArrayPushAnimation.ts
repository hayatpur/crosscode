...
import { cloneData } from '../../../../../transpiler/data'
...
function apply(animation: ArrayPushAnimation, environment: EnvironmentState) {
    ...
    const args = animation.args.map((arg) => resolvePath(environment, arg, `${animation.id}_Data`) as DataState)
...
function computeReadAndWrites(animation: ArrayPushAnimation, object: DataInfo, args: DataInfo[], elements: DataInfo[]) {

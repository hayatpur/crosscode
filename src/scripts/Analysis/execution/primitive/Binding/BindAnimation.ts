...
import { addDataAt, declareVariable, getMemoryLocation, resolvePath } from '../../../transpiler/environment'
...
export function bindAnimation(identifier: string, existingMemorySpecifier: Accessor[] = null): BindAnimation {
    return {

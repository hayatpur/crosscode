...
export class CreateLiteralAnimation extends AnimationNode {
    ...
    begin(environment: Environment, options = { baking: false }) {
        ...
        environment._temps[`CreateLiteralAnimation${this.id}`] = environment.addDataAt([], data);
    ...
    seek(environment: Environment, time: number) {
        ...
        const data = environment.resolvePath(environment._temps[`CreateLiteralAnimation${this.id}`]) as Data;

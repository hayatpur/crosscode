...
export class ReturnAnimation {
    ...
    constructor(execution: ExecutionGraph | ExecutionNode, time: number) {
        ...
        this.trace.classList.add('control-flow-view-connection', 'trail-move', 'trail-return')
    ...
    setReturnDetails(environment: EnvironmentState, returnActionId: string, functionCallId: string) {
        ...
        this.tempReturnEnvironment.render({ environment: this.prevEnvironment, stepId: returnActionId })
    }
    ...
    updateTime(amount: number, environment: EnvironmentRenderer, totalTime: number) {
        ...
        const container = ApplicationState.visualization.view!.scopeContainers[stepIds[prevScopeIndex]]

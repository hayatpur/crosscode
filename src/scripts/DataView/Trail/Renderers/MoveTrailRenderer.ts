...
export class MoveTrailRenderer extends TrailRenderer {
    ...
    constructor(trail: Trail) {
        ...
        this.trace.classList.add('control-flow-view-connection', 'trail-move')

        // Create arrow head
        this.arrowHead = document.createElementNS('http://www.w3.org/2000/svg', 'polygon')
        this.arrowHead.classList.add('control-flow-view-arrow-head', 'trail-move-arrow-head')
        ...
        this.operationExecution = Step.queryExecutionGraph(programExecution, (node) => node.id == operation.executionID)
